...
function StartScene() {
	...
	rect(width * 0.9, height * 0.9, width * 0.1, height *0.05, 50);
	if (mouseX > width * 0.9 - width * 0.1 / 2 && mouseX < width * 0.9 + width * 0.1 / 2 && mouseY > height * 0.9 - height * 0.05 / 2 && mouseY < height * 0.9 + height * 0.05 / 2 && mouseIsPressed) { 
		scene = 3;
	}
	...
	textSize(percX * 2);
	text("CREDITS", width * 0.9, height * 0.905);
	//drawOverlay();
}
